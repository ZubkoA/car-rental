...
import { useMovies } from "./useMuvies";
...
export default function App() {
  ...
  //робимо колбек функцію, щоб відображалось те що в нас є в локал сториджі урок 163
  ...
  function handleAddWatched(movie) {
    ...
    // localStorage.setItem("watched", JSON.stringify([...watched, movie])); те саме що useEffect тільки зберігає дані в локал і не відображає їх 34стр
  }
